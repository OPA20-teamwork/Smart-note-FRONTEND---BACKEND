...
class todoList{
    ...
    createToDoListElement(){
        ...
        this.button.innerText = 'Lägg till';
        ...
        //Appenda element till vår to-do listas element
...
class EditableText{
    ...
    showEditableTextArea(){
        ...
        this.saveButton.innerText = "Spara";
        ...
        function clickSaveButton(event, object){
            // Nummer 13 är "enter" tangenten på tangentbordet

            if (event.keyCode === 13) {
                event.preventDefault();
                // Aktivera knappen genom att klicka på den
